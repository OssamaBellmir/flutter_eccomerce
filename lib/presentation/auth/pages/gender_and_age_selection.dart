...
import 'package:eccomerce_app/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:eccomerce_app/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:eccomerce_app/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:eccomerce_app/core/configs/theme/app_colors.dart';
import '../../../common/widgets/appbar/app_bar.dart';
import 'package:eccomerce_app/common/helper/bottomsheet/app_bottomsheet.dart';
import 'package:eccomerce_app/presentation/auth/widgets/ages.dart';
      ...
      builder: (context, state) {
        return Row(
          ...
          children: [
            ...
            const SizedBox(width: 20), // Fixed typo: SizeBox -> SizedBox
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            // Use state from BlocBuilder or read from context
            color:
